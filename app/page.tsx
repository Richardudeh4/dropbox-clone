...
export default function Home() {
  return (
    <main >
   <div className='flex flex-col md:justify-between items-center lg:flex-row bg-[#1E1919] dark:bg-slate-800 '>
    <div className='p-10 flex flex-col bg-[#2B2929] dark:bg-slate-800 text-white space-y-5'>
      <h1 className='text-5xl font-bold'>Welcome to Dropbox <br/> 
      <br/>
      Storing everything for you and you and your business needs. All in one place
      </h1>
      <p className='pb-20'>
      ...
      <Link href="/dashboard" className='flex item bg-blue-500 p-5 w-fit'>
        Try it for free!
